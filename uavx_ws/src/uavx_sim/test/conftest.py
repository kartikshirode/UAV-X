...
# Chunk 4.2 adds a fourth: uavx_roles owns what a role did, and
# uavx_sim.recovery reads the vehicles' own role files through it rather than
# deciding a second time whether the relay moved.
#
...
SIBLINGS = ("uavx_comms", "uavx_gcs", "uavx_mission", "uavx_roles")
