...
items, enum, pattern, minLength, minimum, minItems, format (date and date-time
only). Anything else in a schema is ignored rather than silently trusted, so if
you add a keyword, add it here too.
